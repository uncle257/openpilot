...
#define HYUNDAI_CANFD_COMMON_RX_CHECKS(pt_bus)                                                                              \
  {.msg = {{0x35, (pt_bus), 32, .max_counter = 0xffU, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U},                   \
           {0x100, (pt_bus), 32, .max_counter = 0xffU, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U},                  \
           {0x105, (pt_bus), 32, .max_counter = 0xffU, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U}}},                \
  {.msg = {{0x175, (pt_bus), 24, .max_counter = 0xffU, .ignore_checksum = true, .ignore_counter = true, .frequency = 50U}, { 0 }, { 0 }}},  \
